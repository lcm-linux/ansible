...
yum -y -q install screen vim ntp lsof net-tools deltarpm glances nethogs nload MegaCli
yum -y -q install wget lrzsz unzip zip expect psmisc iftop iperf tcpdump iptraf telnet dos2unix
